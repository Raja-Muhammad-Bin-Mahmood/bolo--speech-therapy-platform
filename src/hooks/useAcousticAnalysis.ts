...
/** Minimum number of onsets (brief voiced runs) for the 3-onset repetition
 *  classifier path. A 2-run pattern ("woh-woh") can never reach this floor
 *  and is handled by the preserved-fragment path instead. */
